                                ...
                                <div className="flex flex-wrap -m-4  justify-center">
                                    {filterProduct.length > 0
                                                                ...
                                                                <div
                                                                    ...
                                                                    {cartItems.some((p) => p.id === item.id)
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            className=" bg-indigo-700 hover:bg-indigo-600 w-full text-white py-[4px] rounded-lg font-bold">
                                                                            Eliminar el Carrito
                                                                        </button>
                                        ...
                                        <div>
                                            ...
                                            <h1 className=" text-black text-xl">No se encontraron productos {categoryname} </h1>
                                        </div>
                                    }
                                </div>
                            </div>
